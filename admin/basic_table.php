          ...
          <div class="col-md-12">
            <div class="content-panel">
              <table class="table table-striped table-advance table-hover">
                ...
                <thead>
                  <tr>
                    <th><i class="fa fa-picture-o" aria-hidden="true"></i> Foto</th>
                    ...
                    <th><i class="fa fa-calendar-o" aria-hidden="true"></i> Data</th>
                    <th><i class="fa fa-user" aria-hidden="true"></i> Nome</th>
                    <th><i class="fa fa-envelope" aria-hidden="true"></i> E-mail</th>
                    <th><i class="fa fa-phone" aria-hidden="true"></i> Telefone</th>
                    <th><i class="fa fa-street-view" aria-hidden="true"></i> Endereço</th>
                    <th class="hidden-phone"><i class="fa fa-question-circle"></i> Situação</th>
