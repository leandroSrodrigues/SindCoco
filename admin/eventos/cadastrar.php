  ...
  <section id="container">
    ...
    <section id="main-content">
      <section class="wrapper">
       ...
       <h4><i class="fa fa-angle-right"></i> Cadastro de novos Eventos.</h4>
       <div class="row mt">
            ...
            <div class="form-panel" style="border-radius: 10px;">
              ...
              <div class=" form">
                <form class="cmxform form-horizontal style-form" id="commentForm"  action="/admin/eventos/cadastrarEvento.php" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="form-group ">
                    <label for="curl" class="control-label col-lg-2"><i class="glyphicon glyphicon-pencil"></i>Descrição*:</label>
                    <div class="col-lg-10">
                      <textarea class="form-control" name="descricao" id="contact-message" placeholder="Descrição do evento" rows="5" data-rule="required" data-msg="Please write something for us"></textarea>
                    </div>
                  </div>
