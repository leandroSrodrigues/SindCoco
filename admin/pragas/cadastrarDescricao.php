       ...
       <div class="row mt">
          <div class="col-lg-6" style="margin-left: 20%">
            ...
            <div class="form-panel" style="border-radius: 10px;">
              <h4><i class="fa fa-angle-right"></i> Preencha todos os campos. Deve ser adicionado ou uma imagem ou um texto.</h4>
              <div class=" form">
                <form class="cmxform form-horizontal style-form" id="commentForm"  action="/admin/pragas/cadastraDesc.php" method="POST" enctype="multipart/form-data">
