  ...
  <section id="container">
    ...
    <section id="main-content">
      <section class="wrapper">
        ...
        <h4><i class="fa fa-angle-right"></i> Amostragens.</h4>
       <div class="row mt">
          <div class="col-lg-6" style="margin-left: 20%">
            ...
            <div class="form-panel" style="border-radius: 10px;">
              ...
              <div class=" form">
                <form class="cmxform form-horizontal style-form" id="commentForm"  action="/admin/pragas/cadastraTatica.php" method="POST" enctype="multipart/form-data">
