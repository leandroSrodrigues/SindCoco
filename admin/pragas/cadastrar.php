       ...
       <div class="row mt">
          <div class="col-lg-6" style="margin-left: 20%">
            ...
            <div class="form-panel" style="border-radius: 10px;">
              ...
              <div class=" form">
                <form class="cmxform form-horizontal style-form" id="commentForm"  action="/admin/pragas/cadastra.php" method="POST" enctype="multipart/form-data">
                  <br>
                  <div class="form-group ">
                    <label for="cname" class="control-label col-lg-2"><i class="glyphicon glyphicon-pencil"></i> Nome*:</label>
                    <div class="col-lg-10">
                      <input class=" form-control" id="cname" name="nome" minlength="2" type="text" required />
                    </div>
                  </div>
                  <div class="form-group ">
                    <label for="cemail" class="control-label col-lg-2"><i class="glyphicon glyphicon-calendar"></i>Nome's Científicos*:</label>
                    <div class="col-lg-10">
                      <input class="form-control " id="cuser" type="text" name="nomeCientifico" required />
                    </div>
                  </div>
