...
<html class="no-js" lang="">
    <head>
        ...
        <title>Monitoramento Praga/Planta</title>
		...
		<section class="blog-single">
			<div class="container">
				<div class="row" style="margin-top: 50px;">
					<div class="col-md-8">
						<h1 class="font-weight-light  bd bd2" >PRAGAS DE A a Z -<span style="color: green;"> Monitoramento - Praga/planta</span></h1>
                        ...
                        ?>
							...
							<br>
								...
								<div class="textoP">
									<h4>Praga/planta</h4>
									<br>
								 <p >A ocorrência de pragas no coqueiro, como nas demais culturas, está estritamente relacionada as diversas estruturas da planta e fases do seu desenvolvimento.
								Algumas espécies mostram preferência por tecido jovens e tenros, enquanto outras por tecidos mais duros ou fibrosos, como segue:</p>

								<p>Época de ocorrência e principais estruturas vegetais alvo das principais pragas do coqueiro:</p>
								<br>
								<center>
									<img src="/img/monitoramento/tbl-praga-planta.gif" style="max-width: 100%;
								    max-height: 100%;">
								</center>
								</div>
