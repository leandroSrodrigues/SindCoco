		...
		<section class="blog-single">
			<div class="container">
				<div class="row" style="margin-top: 50px;">
					<div class="col-md-8">
						<h1 class="font-weight-light  bd bd2" >Pragas de A a Z -<span style="color: green;"> Pragas - Danos</span></h1><br>
                        <?php
							...
							<?php
								...
								<ul>
									<?php
                                        ...
                                        $sql2 = "SELECT * FROM danos_praga WHERE id_praga = ?";
                                    ...
                                    <center>
                                            ...
                                            ?>
                                            <p> 
                                            	<img src="/img/pragas/<?=$key['descricao'];?>" alt="Blog Image" style="max-width: 100%; max-height: 100%;" width="100%"/></p><br>
                                            </center>
                                            <?php
