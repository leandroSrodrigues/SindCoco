		...
		<section class="blog-single">
			<div class="container">
				<div class="row" style="margin-top: 50px;">
					<div class="col-md-8">
						<h1 class="font-weight-light  bd bd2" >Pragas de A a Z -<span style="color: green;"> Pragas - Táticas de Controle</span></h1><br>
                        <?php
							...
							<?php
								...
								<ul>
									<?php
                                        ...
                                        $sql2 = "SELECT * FROM tatica_praga WHERE id_praga = ?";
