...
include_once"admin/inc/conecta.php";
	...
	$sql= "insert into  classificados_membros (nome, email, fone, cidade, estado, titulo, descricao, preco, obs, data, dia, mes, ano) values ('".$nome."','".$email."','".$fone."','".$cidade."',".$estado.",'".$titulo."','".$descricao."','".$preco."','".$obs."','".$dataInset."',".$d.",".$m.",".$a.")";
	mysql_query($sql, $con);
